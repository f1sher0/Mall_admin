...
export default {
  ...
  methods: {
    loadPost() {
      this.$axios
        .get(this.$httpUrl + "/outIns/loadPost", {
          params: {
            backname: this.form.id,//不要改
    ...
    GetInExport() {//入库报表导出函数
        this.$axios
        .get('http://localhost:5052/outIns/GetInExport',{
    ...
    del(id) {
      this.$axios
        .get(this.$httpUrl + "/outIns" + "/tuihuo?id=" + id, this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
    ...
    save() {
      this.$axios
        .post(this.$httpUrl + "/outIns/save", this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
