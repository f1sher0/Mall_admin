      ...
      <el-container>
        ...
        <el-main>
          ...
          <div style="margin-bottom: 10px">
            ...
            <el-button type="success" @click="add">新增销售登记</el-button>
          ...
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="typeNo" label="国药准字" width="180">
            </el-table-column>
            <el-table-column prop="name" label="药品名字"> </el-table-column>
            <el-table-column prop="custName" label="客户"> </el-table-column>
...
export default {
  ...
  methods: {
    loadPost() {
      this.$axios
        .get(this.$httpUrl + "/sales/loadPost", {
          params: {
            id: this.form.id,
    ...
    GetInExport() {
      // 报表导出函数
      this.$axios
        .get(this.$httpUrl + "/sales/GetSalesExport", {
    ...
    del(id) {
      this.$axios
        .get(this.$httpUrl + "/sales" + "/tuihuo?id=" + id, this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
    ...
    save() {
      this.$axios
        .post(this.$httpUrl + "/sales/save", this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
