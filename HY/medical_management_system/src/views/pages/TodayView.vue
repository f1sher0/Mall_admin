      ...
      <el-container>
        ...
        <el-main>
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            >
            <el-breadcrumb-item>当日统计</el-breadcrumb-item>
          </el-breadcrumb>
          <div
            style="
...
export default {
  ...
  methods: {
    loadPost() {
      this.$axios
        .get(this.$httpUrl + "/stores/dayRecord", {
          // params: {
  ...
  //     fetch("http://localhost:5052/stores/dayRecord")
  ...
  // });
  this.$axios
        .get(this.$httpUrl + "/stores/dayfortableData", {
          params: {
    ...
    GetInExport() {
      //报表导出函数
      this.$axios
        .get( this.$httpUrl + "/stores/dayExport", {
    ...
    del(id) {
      this.$axios
        .get(this.$httpUrl + "/today" + "/removeById?id=" + id, this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
    ...
    save() {
      this.$axios
        .post(this.$httpUrl + "/today/save", this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
