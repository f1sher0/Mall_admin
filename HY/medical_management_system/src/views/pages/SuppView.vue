        ...
        <el-main>
          ...
          <div>
            <el-table :data="tableData" style="width: 100%">
              <el-table-column prop="id" label="供应商id" width="300">
              </el-table-column>

              <el-table-column prop="name" label="供应商姓名" width="300">
              </el-table-column>
              <el-table-column prop="phone" label="供应商联系方式" width="300">
              </el-table-column>
          ...
          <el-dialog title="供应商信息" :visible.sync="dialogFormVisible">
            <el-form :model="form">
              ...
              <el-form-item label="供应商姓名" :label-width="formLabelWidth">
                <el-input v-model="form.name" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="供应商联系方式" :label-width="formLabelWidth">
                <el-input v-model="form.phone" autocomplete="off"></el-input>
              </el-form-item>
              <!-- <el-form-item label="供应商订单" :label-width="formLabelWidth">
                <el-input v-model="form.outInNo" autocomplete="off"></el-input>
              </el-form-item> -->
            </el-form>
...
export default {
  ...
  methods: {
    loadPost() {
      this.$axios
        .get(this.$httpUrl + "/suppliers/loadPost", {
          params: {
    ...
    del(id) {
      //删除函数
      this.$axios
        .get(this.$httpUrl + "/suppliers" + "/removeById?id=" + id, this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
    ...
    save() {
      //保存函数
      this.$axios
        .post(this.$httpUrl + "/suppliers/save", this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
