          ...
          <el-dialog title="药品信息" :visible.sync="dialogFormVisible">
            <el-form :model="form" ref="form"  :inline="true">
              <el-form-item
                ...
                prop="id"
              >
                <el-input v-model="form.id" autocomplete="off" input-width="100px"></el-input>
              </el-form-item>
              <el-form-item
                label="国药准字"
                :label-width="formLabelWidth"
...
export default {
  ...
  methods: {
    loadPost() {
      this.$axios
        .get(this.$httpUrl + "/medicines/loadPost", {
          params: {
            medicineName: this.form.name,
    ...
    del(id) {
      this.$axios
        .get(this.$httpUrl + "/medicines" + "/removeById?id=" + id, this.from)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
    ...
    save() {
      this.$axios
        .post(this.$httpUrl + "/medicines/save", this.form)
        .then((res) => res.data)
        .then((res) => {
          console.log(res);
          if (res.code == 200) {
