...
Source Database       : mamba_1.4

Target Server Type    : MYSQL
Target Server Version : 80022
File Encoding         : 65001

Date: 2024-05-23 16:00:18
*/
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('4', '华为笔记本电脑', '电子产品', '5000.00', '6000.00', '2024-05-23 15:57:42', '2024-05-23 15:57:42', '1');
INSERT INTO `goods` VALUES ('5', '宜家沙发', '家居用品', '1500.00', '2000.00', '2024-05-23 15:57:42', '2024-05-23 15:57:42', '1');
...
-- Records of goodsin
-- ----------------------------
INSERT INTO `goodsin` VALUES ('3', 'GIN001', '1', '华纳电子信息公司', '5000.00', '50000.00', '2024-05-23 10:00:00', '1', '北京仓库', '1', '操作员张三', '首次入库');
INSERT INTO `goodsin` VALUES ('4', 'GIN002', '2', '京东惊喜公司', '1500.00', '15000.00', '2024-05-23 11:00:00', '2', '上海仓库', '2', '操作员李四', '首次入库');
...
INSERT INTO `inlistgoods` VALUES ('5', '2', '2', 'No');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='退货申请表';

-- ----------------------------
-- Records of returnrequest
-- ----------------------------
INSERT INTO `returnrequest` VALUES ('3', '张三', '2024-05-23 15:58:03', '商品有质量问题', '1', '待审核', null, null);
...
CREATE TABLE `user` (
  ...
  `username` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '用户的登录名',
  ...
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '用户的状态',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户信息';
...
INSERT INTO `user` VALUES ('6', 'user1', 'user123', 'F', '25', '010-99999999', 'user1@example.com', '普通用户', '1', null, '2024-05-23 15:58:16', '2024-05-23 15:58:16');
...
-- ----------------------------
INSERT INTO `warehouse` VALUES ('3', '北京仓库', '北京市海淀区学院路', '10000.00', '8000.00');
INSERT INTO `warehouse` VALUES ('4', '上海仓库', '上海市静安区南京西路', '15000.00', '12000.00');
